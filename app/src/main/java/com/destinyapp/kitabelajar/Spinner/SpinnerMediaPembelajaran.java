...
public class SpinnerMediaPembelajaran extends ArrayAdapter<DataModel> {
    public SpinnerMediaPembelajaran(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_tema());
            textId.setText(currentItem.getId_media_tema());
        }
        return convertView;
    }
}
