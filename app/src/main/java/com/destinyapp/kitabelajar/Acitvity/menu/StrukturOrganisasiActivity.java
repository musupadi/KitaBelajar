...
import com.destinyapp.kitabelajar.Adapter.AdapterStrukturOrganisasi;
...
//        });
    ...
    private void Logic(){
        mManager = new LinearLayoutManager(StrukturOrganisasiActivity.this, LinearLayoutManager.VERTICAL,false);
