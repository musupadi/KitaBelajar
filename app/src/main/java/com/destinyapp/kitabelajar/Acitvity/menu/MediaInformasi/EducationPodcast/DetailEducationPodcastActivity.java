package com.destinyapp.kitabelajar.Acitvity.menu.MediaInformasi.EducationPodcast;
        ...
        if (YOUTUBE.isEmpty()){
            ...
            FajarKontol.addFullScreenListener(new YouTubePlayerFullScreenListener() {
                ...
                public void onYouTubePlayerEnterFullScreen() {
                    Intent i = new Intent(DetailEducationPodcastActivity.this, FullScreenYoutubeActivity.class);
